  ...
  const slides: CarouselSlide[] = [
    {
      ...
      title: "Community Volunteering Event",
      description: "Join fellow seniors in making a difference in our community",
      type: 'image'
    },
    {
      id: 2,
      ...
      description: "Stay active and healthy with our community yoga programs",
      type: 'image'
    },
    {
      id: 3,
      ...
      description: "Educational sessions to promote healthy aging and wellness",
      type: 'image'
    },
    {
      id: 4,
      image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=800&h=400&fit=crop",
      title: "Fitness Score Feature",
      description: "Track your wellness journey with our comprehensive fitness scoring",
      type: 'feature'
    },
    {
      id: 5,
      image: "https://images.unsplash.com/photo-1547036967-23d11aacaee0?w=800&h=400&fit=crop",
      title: "\"Aging gracefully is not about living longer, it's about living stronger\"",
      description: "Embrace your golden years with confidence and vitality",
      type: 'quote'
    }
  ];
